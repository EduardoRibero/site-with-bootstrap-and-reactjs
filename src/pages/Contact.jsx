        ...
        <Row>
          <Col>
            <div className="mt-4 mb-5 pb-5">
              ...
              <p className="w-50">
                Na [Nome da Empresa], acreditamos que cada projeto é único. Por isso, trabalhamos em estreita colaboração com nossos clientes, oferecendo soluções personalizadas e um atendimento excepcional. Nosso objetivo é construir espaços que inspirem e proporcionem conforto e funcionalidade.
              </p>
